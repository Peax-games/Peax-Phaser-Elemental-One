var instance = function () {
    ...
    args.unshift({});
    return window.Phaser.Utils.extend.apply(null, args);
};
...
//         noGravity: true,
//         tween: [
//             { x: 0, y: -10, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut },
//             { x: 0, y: 10, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut }
//         ],
//         tweenLoop: true
//     },
...
//         noGravity: true,
//         tween: [
//             { x: -30, y: 45, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut },
//             { x: 30, y: 45, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut },
//             { x: 0, y: 0, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut }
//         ],
//         tweenLoop: true
//     },
//     winStarLeft: {
...
//         noGravity: true,
//         tween: [
//             { x: 60, y: 0, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut },
//             { x: 30, y: -45, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut },
//             { x: 0, y: 0, duration: 800, easing: window.Phaser.Easing.Quadratic.InOut }
//         ],
//         tweenLoop: true
